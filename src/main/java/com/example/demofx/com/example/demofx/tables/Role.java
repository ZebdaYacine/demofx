...
public class Role extends TableImpl<RoleRecord> {
    ...
    /**
     * The reference instance of <code>doctorlite.role</code>
     */
    ...
    /**
     * The column <code>doctorlite.role.id</code>.
     */
    public final TableField<RoleRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>doctorlite.role.name</code>.
     */
    public final TableField<RoleRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(20), this, "");
    ...
    /**
     * Create an aliased <code>doctorlite.role</code> table reference
     */
    ...
    /**
     * Create a <code>doctorlite.role</code> table reference
     */
    public Role() {
