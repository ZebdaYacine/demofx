...
public class Keys {
    ...
    public static final ForeignKey<DiagnosticRecord, UserRecord> DIAGNOSTIC_IBFK_3 = Internal.createForeignKey(Diagnostic.DIAGNOSTIC, DSL.name("diagnostic_ibfk_3"), new TableField[] { Diagnostic.DIAGNOSTIC.IDDOCTOR }, Keys.KEY_USER_PRIMARY, new TableField[] { User.USER.ID }, true);
    public static final ForeignKey<DiagnosticRecord, UserRecord> DIAGNOSTIC_IBFK_4 = Internal.createForeignKey(Diagnostic.DIAGNOSTIC, DSL.name("diagnostic_ibfk_4"), new TableField[] { Diagnostic.DIAGNOSTIC.IDPSYCHOLOGIST }, Keys.KEY_USER_PRIMARY, new TableField[] { User.USER.ID }, true);
